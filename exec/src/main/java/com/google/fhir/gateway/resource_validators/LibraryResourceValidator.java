...
//
//public class LibraryResourceValidator implements AccessChecker, ResourceValidator {
//
...
//    private final Set<String> createAllowedRoles = Set.of(OpenChanjoRoles.SUB_COUNTY_STORE_MANAGER.name(), OpenChanjoRoles.SUB_COUNTY_SYSTEM_ADMINISTRATOR.name());
//    private final Set<String> updateAllowedRoles = Set.of(OpenChanjoRoles.SUB_COUNTY_STORE_MANAGER.name(), OpenChanjoRoles.SUB_COUNTY_SYSTEM_ADMINISTRATOR.name());
//    private final Set<String> deleteAllowedRoles = Set.of(OpenChanjoRoles.SUB_COUNTY_STORE_MANAGER.name(), OpenChanjoRoles.SUB_COUNTY_SYSTEM_ADMINISTRATOR.name());
//    private final Set<String> getAllowedRoles = Set.of(
//            OpenChanjoRoles.SUB_COUNTY_STORE_MANAGER.name(),
